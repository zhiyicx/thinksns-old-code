...
class SessionDb
{
    ...
    {
        $hander = is_array($this->hander) ? $this->hander[0] : $this->hander;
        mysqli_query($hander, 'DELETE FROM '.$this->sessionTable." WHERE session_id = '$sessID'", $hander);
        if (mysqli_affected_rows($hander)) {
            return true;
        }
    ...
    {
        $hander = is_array($this->hander) ? $this->hander[0] : $this->hander;
        mysqli_query($hander, 'DELETE FROM '.$this->sessionTable.' WHERE session_expire < '.time(), $hander);
