...
class ValidationModel extends Model
{
    ...
    protected $fields = [0 => 'validation_id', 1 => 'type', 2 => 'from_uid', 3 => 'to_user', 4 => 'data', 5 => 'code', 6 => 'target_url', 7 => 'is_active', 8 => 'ctime', '_autoinc' => true, '_pk' => 'validation_id'];
    ...
    public function addValidation($from_uid, $to_user, $target_url, $type = '', $data = '')
    {
        ...
        if ($vid) {
            ...
            $res = model('Validation')->where("`validation_id`=$vid")->setField(['code', 'target_url'], [$validation_code, $target_url]);
            if ($res) {
                return $target_url;
            } else {
                return false;
