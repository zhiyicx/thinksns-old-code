...
class UserDataModel extends Model
{
    ...
    protected $fields = [0 => 'id', 1 => 'uid', 2 => 'key', 3 => 'value', 4 => 'mtime', 5 => 'at_value'];
    protected $uid = '';
    ...
    public function updateUserData()
    {
        ...
        $map['uid'] = ['in', $uids];
        $map['key'] = ['in', ['feed_count', 'weibo_count', 'favorite_count', 'following_count', 'follower_count', 'collect_blog_count', 'collect_topic_count', 'collect_total_count']];
        $this->where($map)->delete();
